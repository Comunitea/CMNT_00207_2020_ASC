...
class StockInvoiceDeposit(models.TransientModel):
    ...
    def create_invoice(self):
        ...
        inv_ids = deposits.mapped(lambda x: x.sale_id).with_context(my_context).action_invoice_create()
        ...
        for sale in deposits.mapped(lambda x: x.sale_id):
            ...
            for line in sale_lines:
                line_vals_list = line.with_context(my_context).invoice_line_create_vals(invoice.id, line.qty_to_invoice)
