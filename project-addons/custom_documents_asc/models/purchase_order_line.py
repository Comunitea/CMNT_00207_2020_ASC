...
class PurchaseOrderLine(models.Model):
    ...
    product_min_qty = fields.Float(
        "Product Min Qty", related="orderpoint_id.product_min_qty"
    )
    product_max_qty = fields.Float(
        "Product Max Qty", related="orderpoint_id.product_max_qty"
    )
    product_qty_multiple = fields.Float(
        "Qty Multiple", related="orderpoint_id.qty_multiple"
    )
    product_qty_available_not_res = fields.Float(
        string="Quantity On Hand Unreserved",
        compute="_compute_product_qty_available_not_res",
    )
